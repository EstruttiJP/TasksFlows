...
@JsonPropertyOrder({ "id", "name", "description", "creator", "launchDate", "deadline", "memberIds" })
public class ProjectVO extends RepresentationModel<ProjectVO> implements Serializable {
	...
	@Mapping("members")
	private List<Long> memberIds; // Apenas IDs dos membros
